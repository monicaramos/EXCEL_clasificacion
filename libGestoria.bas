...
NombreHoja = Command
'NombreHoja = "/B|ariagro8|" '"/L|ariagro1|22000|1|"
'NombreHoja = "/A|ariagro15|"
'NombreHoja = "/I|ariagro8|22000|"
...
Select Case Mid(NombreHoja, 1, 1)
    ...
    Case "E"
        EsImportaci = 2
    Case "L" ' Exportacion de listados de recoleccion
        EsImportaci = 3
    Case "A" ' Importacion de entradas clasificadas de Anna
        EsImportaci = 4
    Case "B" ' Importacion de clasificacion para Alzira
        EsImportaci = 5
End Select
...
If EsImportaci = 2 Or EsImportaci = 3 Then
...
If EsImportaci = 1 Or EsImportaci = 3 Then
    Usuario = RecuperaValor(NombreHoja, 3)
End If

If EsImportaci = 3 Then
    TipoListado = RecuperaValor(NombreHoja, 4)
End If
